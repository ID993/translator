...
def anthropic_translation(text, src_lang, tgt_lang):
    ...
    if isinstance(text, str):
        logger.info(f"\nTRANSLATION CT: {response.content[0].text}\n")
